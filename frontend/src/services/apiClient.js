...
let API_BASE_URL = process.env.REACT_APP_BACKEND_URL || 'https://a0594035-ee12-4fe8-b64d-3b8a258db8bd.preview.emergentagent.com';
...
if (isProductionOrHTTPS) {
  ...
  if (!API_BASE_URL.startsWith('https:')) {
    API_BASE_URL = 'https://a0594035-ee12-4fe8-b64d-3b8a258db8bd.preview.emergentagent.com';
  }
}
