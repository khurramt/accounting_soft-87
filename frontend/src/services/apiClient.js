...
let API_BASE_URL = process.env.REACT_APP_BACKEND_URL || 'https://9079b6b8-23aa-49d5-a340-0d71a542f71e.preview.emergentagent.com';
...
if (isProductionOrHTTPS) {
  ...
  if (!API_BASE_URL.startsWith('https:')) {
    API_BASE_URL = 'https://9079b6b8-23aa-49d5-a340-0d71a542f71e.preview.emergentagent.com';
  }
}
